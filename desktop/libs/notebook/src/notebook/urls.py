...
from notebook import views, api
...
urlpatterns += [
  ...
  url(r'^api/autocomplete/(?P<database>\w+)/(?P<table>[\w_\-]+)/?$', api.autocomplete, name='api_autocomplete_columns'),
  url(r'^api/autocomplete/(?P<database>\w+)/(?P<table>[\w_\-]+)/(?P<column>\w+)/?$', api.autocomplete, name='api_autocomplete_column'),
  url(r'^api/autocomplete/(?P<database>\w+)/(?P<table>[\w_\-]+)/(?P<column>\w+)/(?P<nested>.+)/?$', api.autocomplete, name='api_autocomplete_nested'),
  url(r'^api/sample/(?P<database>\w+)/(?P<table>[\w_\-]+)/?$', api.get_sample_data, name='api_sample_data'),
  url(r'^api/sample/(?P<database>\w+)/(?P<table>[\w_\-]+)/(?P<column>\w+)/?$', api.get_sample_data, name='api_sample_data_column'),
